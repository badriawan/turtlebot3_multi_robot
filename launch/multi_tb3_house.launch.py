...
def generate_launch_description():
    ...
    robots = [
        ...
        {'name': 'tb2', 'x_pose': '-1.5', 'y_pose': '1.5', 'z_pose': 0.01},
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'nav_params_file',
        default_value=os.path.join(package_dir, 'params', 'nav2_house_params.yaml'),
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('turtlebot3_multi_robot'), 'maps', 'turtlebot3_house.yaml'),
                     },],
